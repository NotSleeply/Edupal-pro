  ...
  const renderAnswerResult = () => {
    ...
    return (
      <div className="mt-6 p-6 rounded-lg mb-6 border border-gray-200 w-full max-w-2xl mx-auto">
        ...
        <button
          className="mt-5 w-full py-3 bg-gray-700 text-white rounded-lg hover:bg-gray-800 transition-colors text-base font-medium"
    ...
    return (
      <div className="text-center p-8 bg-white rounded-xl shadow-lg w-[90vw] max-w-2xl mx-auto">
        ...
        <div className="flex gap-4">
          <button
            className="flex-1 py-3 bg-gray-700 text-white rounded-lg hover:bg-gray-800 transition-colors text-base font-medium"
            onClick={startPK}
          >
            再来一局
          </button>
          <button
            className="flex-1 py-3 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors text-base font-medium"
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center p-4 w-full">
        {!isPkStarted ? (
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 w-[90vw] max-w-2xl mx-auto">
            ...
            <button
              onClick={startPK}
              className="w-full py-3 bg-gray-700 text-white rounded-lg hover:bg-gray-800 transition-colors text-base font-medium"
            >
              开始挑战
            </button>
          </div>
